...
```{r}
## comparison of ratio of effectors to noneffectors in PC1

## in PC1

print(length(colnames(df_pc1)[colnames(df_pc1) %in% effector_ogs])/length(colnames(df_pc1)[! (colnames(df_pc1) %in% effector_ogs)]))

## in all

print(length(colnames(df)[colnames(df) %in% effector_ogs])/length(colnames(df)[! (colnames(df) %in% effector_ogs)]))
